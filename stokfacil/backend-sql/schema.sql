-- Schema de estoque para StokFácil
-- Cria a tabela de produtos com atributos importantes para controle de estoque.
...
-- Consultas úteis
-- 1. Listar todos os produtos com estoque baixo
SELECT *
FROM produtos
